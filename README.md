...
To set up, simply run the application, port forward port 8554 through your router, click start server, and share your public RTSP URL
For VRChat, simply change the beginning of the URL to "rtspt".

For controller forwarding be sure to install ViGEmBus
